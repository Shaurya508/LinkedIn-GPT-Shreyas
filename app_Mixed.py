...
def create_ui():
    ...
    st.markdown("<h2 style='text-align: center; color: #0adbfc;'><u> Venkat's LinkedIn GPT (NEW)</u></h2>", unsafe_allow_html=True)
    st.sidebar.image("Aryma Labs Logo.jpeg")
    st.sidebar.markdown("<h3 style='color: #08daff;'>Welcome to Venkat's LinkedIn GPT (NEW)</h2>", unsafe_allow_html=True)
    ...
    with chat_container:
        if st.session_state.conversation_history == []:
            ...
            with col2:
                ...
                st.write("Hello, I am Venkat's LinkedIn GPT (NEW) . How can I help you?")
